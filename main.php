...
<!-- Function to limit the inputted characters -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" width="40" height="40" src="assets/img/logo_jateng23.png" alt="Logo"> 
          <span style="font-size:50px">SIBS</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <!-- call file "top-menu.php" to perform menu -->
      ...
      <div class="content-wrapper">
        ...
        <!-- call file "content-menu.php" to perform content -->
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 <a href="http://rzknug.ndoro.id/"> &raquo; Team SIBS</a></strong>
      </footer>
    </div><!-- ./wrapper -->
