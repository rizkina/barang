...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_in,a.date_in,a.id_brg,a.jml_in,b.id_brg,b.nm_brg,b.satuan
                                    ...
                                    WHERE a.date_in BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ORDER BY a.id_in ASC") 
    ...
    // if data does not exist
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[id_in]</td>
                        ...
                        <td style='padding-right:10px;' width='100' height='13' align='right' valign='middle'>$data[jml_in]</td>
