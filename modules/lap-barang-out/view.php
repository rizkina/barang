  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/lap-barang-out/cetak.php" target="_blank">
          <div class="box-body">
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-1 col-sm-11">
                ...
                <a class="btn btn-primary btn-social pull-right" href="modules/lap-barang-out/excel.php" target="_blank">
